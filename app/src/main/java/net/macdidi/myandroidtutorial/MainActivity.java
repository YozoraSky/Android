...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(AboutActivity.employee==null)
            show_app_name.setText("Android Camera");
        else
            show_app_name.setText("Android Camera" + AboutActivity.employee);
    }
